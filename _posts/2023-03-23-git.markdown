...
After downloading Git you can either open a terminal window or a Git Bash window. It can be a good idea to configure your Git profile by adding your name and email.
